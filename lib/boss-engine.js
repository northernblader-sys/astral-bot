...
// How much of a boss's ATK actually reaches the player. Raised 0.60 → 0.75
// (2026-09-21): "the bosses are still too weak, their attacks a bit stronger".
// Every boss strike in the game funnels through this one multiplier (plus the
// two special-case shares of it below: the8% chip and the40% graze), so one
// knob moves all boss pressure together without touching their HP curve.
const BOSS_DAMAGE_TO_PLAYER_SCALE = 0.75
