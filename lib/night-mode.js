 ...
 *     a "go to sleep, back tomorrow" notice — except ban appeals and spawn
 *     claims (.claim / .collect / .grab), which the handler lets through via
 *     isNightModeAllowed() so a card or series already on the floor can still
 *     be grabbed; and
...
const STATE_PATH = runtimePath('night-mode.json')
