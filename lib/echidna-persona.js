 ...
 *      in-memory state). Fed to the AI (lib/openrouter.js) as prior user/assistant turns.
 *
...
// enough that a long chat can't balloon the AI request.
export const ECHIDNA_MEMORY_TURNS = 6

const memory = new Map() // ownerJid -> [{ role: 'user'|'assistant', content }]

/** The owner's recent turns, as AI chat turns (oldest first). */
