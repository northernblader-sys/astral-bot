...
// Priced at a markup over cardSellPrice (~2.4x) so buying-then-selling is never
// a profitable loop. Every tier the Cards API can return has an entry: tier 5
// used to be missing, which made cardBuyPrice(5) fall through the `?? [1]`
// default and quietly sell a tier-5 card for the tier-1 price of 500.
const TIER_BUY_PRICE = {
  1: 500, 2: 1200, 3: 3000, 4: 7500, 5: 19000,
  6: 35000, S: 70000,
}
