...
export function playerHitLine(playerName, enemy, dmg, isCrit) {
  return pick(isCrit ? PLAYER_CRIT : PLAYER_HIT)(playerName, enemy, dmg)
}
export function playerMissLine(playerName, enemy) {
  return pick(PLAYER_MISS)(playerName, enemy)
}
export function playerAbsorbedLine(playerName, enemy) {
  return pick(PLAYER_ABSORBED)(playerName, enemy)
}
export function enemyHitLine(enemy, dmg) {
  return pick(ENEMY_HIT)(enemy, dmg)
}
export function enemyMissLine(enemy) {
